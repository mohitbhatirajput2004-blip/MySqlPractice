...
(8, 'Hijdi', 'Developer', 5, 60000),
(9, 'Ivan', 'Developer', 5, 58000),
(10, 'chudy', 'Developer', 6, 59000),
...
select mag.emp_name , count(mag.emp_id) from employee as emp
join employee as mag where emp.manager_id =  mag.emp_id  group by mag.emp_name;
